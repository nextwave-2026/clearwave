...
file is NOT union-merged, so it can genuinely conflict. A conflict here means both sides are changing the same boundary at once: agree on the shape, then commit the agreed version.
