...
- [0014 - Detection qualifies an incident behind four floors](0014-detection-floors-not-a-single-threshold.md)
- [0015 - Severity is bounded by money, not only weighted by it](0015-severity-is-bounded-by-money.md)
- [0016 - Localisation descends on sibling contrast, not on depth](0016-localisation-descends-on-contrast.md)
- [0017 - All detection arithmetic buckets on event time](0017-event-time-bucketing.md)
- [0018 - Value is priced per payment, never per attempt](0018-value-is-priced-per-payment.md)
- [0019 - Native source shapes are normalised through a mapper registry](0019-native-shapes-through-a-mapper-registry.md)
- [0020 - The canonical model closes the decline vocabulary and preserves the raw code](0020-canonical-vocabulary-with-preserved-raw-code.md)
